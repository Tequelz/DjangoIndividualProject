...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Module',
            fields=[
                ('mod_id', models.IntegerField(max_length=5, primary_key=True, serialize=False)),
        ...
        migrations.AddConstraint(
            model_name='lecture',
            constraint=models.UniqueConstraint(fields=('lec_id', 'lec_number'), name='unique_lecture'),
        ),
    ]
